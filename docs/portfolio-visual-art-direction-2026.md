...
Статус: реализовано в локальной версии сайта
...
- десктопные первые экраны и внутренние главы визуально проверены в браузере;
- мобильные первые экраны проверены при ширине 390 пикселей;
- горизонтального переполнения нет;
- изображения первого экрана загружаются корректно;
